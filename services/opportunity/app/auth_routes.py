"""Authentication routes for Opportunity Service."""
...
FAKE_USERS_DB = {
    "admin": {
        ...
        "disabled": False,
        "scopes": ["opportunities:read", "opportunities:write", "admin"],
    },
    "analyst": {
        "username": "analyst",
...
async def login(form_data: Annotated[OAuth2PasswordRequestForm, Depends()]) -> Token:
    ...
    Returns a JWT token for accessing opportunity endpoints.
    """
